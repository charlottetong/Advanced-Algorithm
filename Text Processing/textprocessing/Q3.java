...
public class Q3<Value> {
    ...
    **************************************************************/
    ...
    public static void main(String[] args) {
        ...
        StringTokenizer str = new StringTokenizer(txt, " \t\n\r\f,.:;?![]'-");
        keys = new String[str.countTokens()];
        while ( str.hasMoreTokens() )
        {
        	
        	keys[count]=str.nextToken();
      ...
      //  }
        ...
        String key = "protein";  
        StdOut.println("key = protein, value = "+ st.get(key));
        
        String key1 = "complex";  
        StdOut.println("key = complex, value = "+ st.get(key1));
        
        String key2 = "PPI";  
        StdOut.println("key = PPI, value = "+ st.get(key2));
        
        String key3 = "prediction";  
        StdOut.println("key = prediction, value = "+ st.get(key3));
        
        String key4 = "In";  
        StdOut.println("key = In, value = "+ st.get(key4));
        
        String key5 = "Interaction";  
        StdOut.println("key = Interaction, value = "+ st.get(key5));
